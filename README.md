...
_Seq2Seq model for forecasting the closing price of seven major cryptocurrencies using recent temporal windows._

---

## **Overview**  
This project showcases the implementation of a **sequence-to-sequence (Seq2Seq)** deep learning model designed to predict short-term cryptocurrency closing prices. The model uses: 
...
## **Key Features**  
- Seq2Seq architecture with LSTM encoder–decoder structure.
- Attention mechanism to enhance temporal dependency modeling.
...
1. Clone the repository:  
   ```bash
   git clone https://github.com/angelmdezhdez/seq2seq-for-cryptos.git
